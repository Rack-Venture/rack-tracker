...
async def preview_analysis(
    ...
    try:
        ...
        if transient_upload_path:
            _cleanup_transient_upload(transient_upload_path)
...
def _cleanup_transient_upload(source_path: str) -> None:
    try:
