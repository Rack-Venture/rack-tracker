...
- `/jobs/{job_id}/benchmark/frames`
  - 프레임별 `mpImageCreationMs`, `inferenceMs`, `serializationMs`, `poseDetected`, visibility 지표를 반환합니다.

현재 benchmark는 아래 정보를 기록합니다.

- 단계별 시간: `frameExtractionMs`, `mpImageCreationMs`, `inferenceMs`, `serializationMs`, `analysisMs`, `totalElapsedMs`
