...
| :---: | :--- | :--- | :--- | :--- |
| <img src="https://github.com/lhk0721.png" width="100" height="100" style="object-fit: cover; border-radius: 50%;"> | **이&nbsp;현&nbsp;규** | Core / AI · Team Lead | 프로젝트 리드, 포즈 추정 파이프라인 설계 및 구현, 협업 시스템 구축, 사업화 방향 정렬 | PoseLandmarker 통합, 3D synthesis 파이프라인, 랙 추적 알고리즘, 문서 체계 수립 |
| — | **이&nbsp;지&nbsp;원** | | | |
| — | **장&nbsp;효&nbsp;인** | | | |
| — | **전&nbsp;효&nbsp;원** | | | |
| — | **신&nbsp;은&nbsp;수** | | | |
...
> 본 저장소는 졸업 프로젝트 팀원과 외부 인원이 함께 기여할 수 있는 commercial org에 속한다. 외부 합류자는 본인 행을 직접 채워 PR한다.
