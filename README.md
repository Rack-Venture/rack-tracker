...
| :---: | :--- | :--- | :--- | :--- | :--- |
| <img src="https://github.com/lhk0721.png" width="100" height="100" style="object-fit: cover; border-radius: 50%;"> | **이&nbsp;현&nbsp;규** | 상명대학교 — 학생 (Founder / Team Lead) | Core / AI · 사업화 | 프로젝트 리드. 포즈 추정·3D synthesis 파이프라인 설계 및 구현, AI 모델 어댑터 레이어 분리한 모듈형 아키텍처 설계, FastAPI 비동기 처리 구조 직접 구현. 사업화 방향 정렬과 협업·문서 체계 수립. | 경제금융학과 + 휴먼AI공학(복수전공). 다국적 웹 에이전시 PM, (주)모두의연구소 응용소프트엔지니어링 과정 이수. 2026-05-16 NVIDIA 전담 AI 코어 엔지니어 교육과정(SeSAC 서대문캠퍼스) 선발. |
...
| — | **전&nbsp;태&nbsp;웅** | 현대모비스 — 연구원 (학생 외) | Biomechanics R&D | 물리학 기반 운동역학 분석 모델 설계·고도화. 단순 자세 인식을 넘어 관절 정렬, 움직임 궤적, 반복 수행 패턴, 좌우 비대칭 등 **운동 수행 품질 해석** 로직 설계. | University of Warwick 기계공학 석사. (전)한화에어로스페이스, (현)현대모비스 연구원. 표준화된 R&D 경험 기반. |
