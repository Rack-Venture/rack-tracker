...
- For git, branch, commit, push, and PR rules, read `docs/agent-workflow/git-rules.md`.
- For management-document updates and work log rules, read `docs/agent-workflow/documentation-rules.md`.
...
- If the task belongs to tracked work, open the matching management document under `docs/issues/` before editing files.
...
- When the user asks to continue, resume, or update existing work, first search under `docs/issues/` for a clearly matching management document.
